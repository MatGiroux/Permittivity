...
def eps_FC_I_baltz_calc(w,E_F,eps_inf,epsilon0,e,N,hbar,m_star,Eg_0_T,U): #this is the calculation of the imaginary part of the permittivity at high doping taken from Baltz 1972 https://doi.org/10.1002/pssb.2220510209
...
def eps_FC_I_calc(w,E_F,eps_inf,epsilon0,e,N,hbar,m_star,wp_square,Eg_0_T,eps_Drude,U): #this model computes the imaginary part of the permittivity at high doping by combining the Baltz and Brude model depending on the region
    ...
    #for the case where w>w_p
    eps_FC_I_2=eps_FC_I_baltz_calc(w_2,E_F,eps_inf,epsilon0,e,N,hbar,m_star,Eg_0_T,U)
...
def eps_FCL_calc(w,N,T,eps_inf,m0,mhh,mlh,N_doped,Eg_0_T,kb,hbar,P,U):#this function computes the free carrier and lattice response of the permittivity using a Drude-Lorentz model
    ...
    if N_doped==True: #if the sample is N-doped
        if E_F<kb*T:#for the low doping case
            ...
            eps_FC_I=eps_FC_I_calc(w,E_F,eps_inf,epsilon0,e,N,hbar,m_star,wp_square,Eg_0_T,eps_Drude,U) #computing the imaginary part of the permittivity
