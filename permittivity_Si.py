...
def tau_calc(U,el,me,mh,T,T_inf,ND,NA): #this function computes the scattering time of electrons and holes (this model is from Fu 2005 except for the room temperature scattering rates which is from Basu 2010)
...
def mu_e_calc(U,ND): #this function computes the mobility of electrons (this is from Basu 2010)
...
def mu_h_calc(U,NA): #this function computes the mobility of holes (this is from Basu 2010)
...
def carrier_concentrations(U,ND,NA,T,T_inf,kb,Eg): #this function computes the carrier concentrations for the donor and acceptor contribution (from Basu 2010 and Fu 2005)
...
def F1(U,x): #this is a function used to evaluate the absorption coefficient associated with phonons of 212K equivalent energy (from Timans 1993)
...
def F2(U,x): #this is a function used to evaluate the absorption coefficient associated with phonons of 670K equivalent energy (from Timans 1993)
...
def alpha_3_calc(U,kb,E,Eg,T): #this function computes the absorption coefficient associated with phonons of 1050K equivalent energy (from Timans 1993)
...
def alpha_4_calc(U,kb,E,Eg,T): #this function computes the absorption coefficient associated with phonons of 1420K equivalent energy (from Timans 1993)
...
def alpha_IB_calc(U,lambd,Eg,hbar,kb,T): #this function computes the interband absorption using the model in Timans 1993
...
def eps_r_calc(U,T): #this function computes the eps_r coefficient (from Lee 2005)
...
def g_calc(U,T): #this function computes the g coefficient (from Lee 2005)
...
def eta_calc(U,T): #this function computes the eta coefficient (from Lee 2005)
...
def eps_bl_calc(U,lambd,T,Eg,hbar,kb): #this function computes the epsilon_bl component using Lee 2005 and alpha_IB from Timans 1993
