...
def Plotting(hbar,w,epsilon,title): #this function generates a plot of the real and imaginary part of the permittivity
    ...
    ############################## Second plot ####################################
    plt.subplot(1, 2, 2)
    plt.loglog((hbar*w).to('eV'), epsilon.imag.to('dimensionless'), label="emitter", color="blue")
    # Printing a title to the graph and the axes
    plt.xlabel("Photon energy [eV]")
...
epsilon_InAs = permittivity_InAs.epsilon_InAs(lambd,N,T,N_doped,U)
